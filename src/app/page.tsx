          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6">
            {features.map((feature, index) => (
              <div
                ...
                onClick={() =>
                  document
                    .getElementById(feature.href.slice(1))
        ...
        <div className="max-w-7xl mx-auto space-y-24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-foreground/80 mb-6">
                  Follow our comprehensive guide to conduct a thorough risk
                  assessment for your startup. Our structured approach ensures
                  you don't miss any critical factors.
                </p>
              ...
              <div className="bg-secondary p-8 rounded-xl">
                ...
                <div className="space-y-4">
                  <div className="flex items-center p-4 bg-background rounded-lg">
                    <span className="bg-primary text-primary-foreground w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold mr-4">
                      1
                    </span>
          ...
          <div id="startup-costs" className="scroll-mt-20">
            <div className="text-center mb-12">
              ...
              <p className="text-foreground/80 max-w-2xl mx-auto">
                Calculate all initial costs required to launch your business,
                from legal fees to equipment and marketing.
              </p>
            </div>
            <div className="bg-secondary p-8 rounded-xl">
          ...
          <div id="cogs-calculator" className="scroll-mt-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-foreground/80 mb-6">
                  Determine your Cost of Goods Sold to understand your gross
                  margins and pricing strategy. Essential for product-based
                  businesses.
                </p>
                <div className="space-y-4">
              ...
              <div className="bg-secondary p-8 rounded-xl">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-foreground/70">
                    A healthy gross margin typically ranges from 20-80%
          ...
          <div id="sales-forecast" className="scroll-mt-20">
            <div className="text-center mb-12">
              ...
              <p className="text-foreground/80 max-w-2xl mx-auto">
                Project your revenue streams and understand your market
                potential with our advanced forecasting tools.
              </p>
            </div>
          ...
          <div id="salaries" className="scroll-mt-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-foreground/80 mb-6">
                  Plan your workforce costs and compensation structure to ensure
              ...
              <div className="bg-secondary p-8 rounded-xl">
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-border">
                    <p className="text-sm text-foreground/70">
                      Consider market rates, experience levels, and equity
                      distribution for early-stage companies.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div id="forecast-pl" className="scroll-mt-20">
            <div className="text-center mb-12">
              ...
              <p className="text-foreground/80 max-w-2xl mx-auto">
                Project your profit and loss statements to understand your
                financial trajectory and identify key drivers.
              </p>
            </div>
            <div className="bg-secondary p-8 rounded-xl">
          ...
          <div id="break-even" className="scroll-mt-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-foreground/80 mb-6">
                  Calculate when your business becomes profitable and understand
                  the key metrics that drive your break-even point.
                </p>
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-4 bg-secondary rounded-lg">
              ...
              <div className="bg-secondary p-8 rounded-xl">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-foreground/70">
                    Based on current projections and market assumptions.
          ...
          <div id="funding" className="scroll-mt-20">
            <div className="text-center mb-12">
              ...
              <p className="text-foreground/80 max-w-2xl mx-auto">
                Analyze your funding requirements and explore different sources
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-secondary p-6 rounded-xl text-center">
                ...
                <p className="text-sm text-foreground/70">
                  Self-funding with personal savings and revenue
                </p>
              </div>
              <div className="bg-secondary p-6 rounded-xl text-center">
                <div className="text-2xl mb-2">👥</div>
                ...
                <p className="text-sm text-foreground/70">
                  Early-stage funding from personal network
                </p>
              </div>
              <div className="bg-secondary p-6 rounded-xl text-center">
                <div className="text-2xl mb-2">🦄</div>
                ...
                <p className="text-sm text-foreground/70">
                  Individual investors providing seed capital
                </p>
              </div>
              <div className="bg-secondary p-6 rounded-xl text-center">
                <div className="text-2xl mb-2">🏢</div>
                ...
                <p className="text-sm text-foreground/70">
                  Institutional funding for growth-stage companies
                </p>
              </div>
            </div>
          </div>
          ...
          <div id="unit-economics" className="scroll-mt-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-foreground/80 mb-6">
                  Understand the profitability of each customer or transaction
                  to optimize your business model and pricing strategy.
                </p>
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-4 bg-secondary rounded-lg">
              ...
              <div className="bg-secondary p-8 rounded-xl">
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-foreground/70">
                    Target LTV/CAC ratio of 3:1 or higher for sustainable
                    growth. Focus on increasing LTV and reducing CAC.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div id="glossary" className="scroll-mt-20">
            <div className="text-center mb-12">
              ...
              <p className="text-foreground/80 max-w-2xl mx-auto">
                Essential business and financial terms to help you understand
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-secondary p-6 rounded-xl">
                ...
                <div className="space-y-2 text-sm">
                  <div>
                    <strong>COGS:</strong> Cost of Goods Sold - direct costs of
                    producing goods
                  </div>
                  <div>
                    <strong>LTV:</strong> Lifetime Value - total revenue from a
                    customer
                  </div>
                  <div>
                    <strong>CAC:</strong> Customer Acquisition Cost - cost to
                    acquire a customer
                  </div>
                  <div>
                    <strong>Gross Margin:</strong> Revenue minus COGS, expressed
                    as percentage
                  </div>
                </div>
              </div>
              <div className="bg-secondary p-6 rounded-xl">
                ...
                <div className="space-y-2 text-sm">
                  <div>
                    <strong>Break-even:</strong> Point where revenue equals
                    total costs
                  </div>
                  <div>
                    <strong>Unit Economics:</strong> Profitability analysis per
                    customer/transaction
                  </div>
                  <div>
                    <strong>Runway:</strong> Time until cash runs out
                  </div>
                  <div>
                    <strong>Burn Rate:</strong> Rate at which company spends
                    cash
                  </div>
                </div>
              </div>
